A small "Address book" app that allows:
...
Spend not more than 8 hours on this task, finish with whatever working version if you are out of time. Write down total time spent on the task.